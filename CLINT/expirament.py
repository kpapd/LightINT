...
from p4_mininet import P4Host, P4Switch #, P4RuntimeSwitch
...
class ExerciseRunner:
    ...
    def do_net_cli(self):
        ...
        #h01 = self.net.get('h01')


        #Fix rate depending on underlying hardware
        print('Packet rate: 20')
        ...
        os.system('echo "---Output Analysis---" | tee expirament.out')       

        os.system('python3 parsepcap.py s12-eth2 10.0.1.1 10.0.1.12 2 '+telvalues+' | tee -a expirament.out')  
        #os.system('python3 parsepcap.py s3-eth3 10.0.1.21 10.0.1.3 2 '+telvalues+' | tee -a expirament.out')  
        #os.system('python3 parsepcap.py s17-eth3 10.0.1.8 10.0.1.17 2 '+telvalues+' | tee -a expirament.out')  
        #os.system('python3 parsepcap.py s9-eth4 10.0.1.18 10.0.1.9 2 '+telvalues+' | tee -a expirament.out')   
         
        
        #CLI(self.net)


        #Read Total values of Accurate and Inaccurate paths and found vs lost switch IDs
                                                        ...
                                                        if (lin.find('Valuable INT packets= ')>-1):
                                                            ...
                                                            if (lin.find('Total Duplicates= ')>-1):
                                                                ...
                                                                if (lin.find('Extra INT packets= ')>-1):
                                                                    ...
                                                                    if (lin.find('Path Update Unordered detected by= ')>-1):
                                                                        totAltUn+=int(lin[lin.find('= ')+2:])
                                                                '''
        ...
        #print('Total path updates unordered detected = ', totAltUn)
        ...
        mult.write(str('1\t')+str(acc)+'\t'+str(inacc)+'\t'+str(totfound)+'\t'+str(totlost)+'\t'+str(totAlt)+'\t'+str(avg)+'\t'+str(totFlows)+'\t'+str(totLReset)+'\t'+str(totPacks)+'\t'+str(totINT)+'\t'+str(totExtraINT)+'\t'+str(totValINT)+'\t'+str(totDupl))
...
if __name__ == '__main__':
    ...
    telvalues = str(args.telemetry_values)
    print(telvalues)
