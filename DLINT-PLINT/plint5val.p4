    ...
    apply {
        ...
        if (hdr.tcp.isValid()) {
            ...
            if (!hdr.swtraces.isValid()) {  
                ...
                hdr.swtraces.hopnum4 = 1;
                hdr.swtraces.swid5 = thisswid;
                hdr.swtraces.hopnum5 = 1;
                } else {
                    random(rand,1,100);
                    ...
                    if ((bit<16>)rand*(bit<16>)((bit<8>)hdr.swtraces.initttl-hdr.ipv4.ttl)<= (bit<16>)100) {                        
                        hdr.swtraces.swid4 = thisswid;
                        hdr.swtraces.hopnum4 = hdr.swtraces.initttl-hdr.ipv4.ttl;
                    }
                    random(rand,1,100);
                    if ((bit<16>)rand*(bit<16>)((bit<8>)hdr.swtraces.initttl-hdr.ipv4.ttl)<= (bit<16>)100) {                        
                        hdr.swtraces.swid5 = thisswid;
                        hdr.swtraces.hopnum5 = hdr.swtraces.initttl-hdr.ipv4.ttl;
                    }
                }
